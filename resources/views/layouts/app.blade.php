        ...
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
            <div class="container">
                <a class="navbar-brand d-flex" href="{{ url('/') }}">
                    <div><img src="{{ asset('img/logo.png') }}" alt="Logo" style="height:26px;border-right:1px solid #000" class="px-3"></div>
                        ...
                        @else
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                                    <a href="{{ route('find-freinds') }}" class="dropdown-item">
                                        Find Freinds
                                    </a>
                                    <a href="/profile/{{auth()->user()->id}}" class="dropdown-item">
                                        Profile
                                    </a>
                                    <a href="/chats" class="dropdown-item">
                                        Chats
                                    </a>
